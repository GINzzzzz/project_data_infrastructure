...
[x] 2) таблица ptv_routes: информация о маршрутной сети. Изначально предполагается использование для информации о существующих маршрутах. Но при необходимости может быть использована для моделирования 
       перспективных маршрутных сетей. В составе программы обработки реестра есть функционал расчет пробегов по дням недели и месяцам при наличии хотя бы базовых графиков (дни обслуживания). Принципиально то же 
       самое, что и аналогичная таблица в Генеральной БД, но на уровне объекта проектирования.
